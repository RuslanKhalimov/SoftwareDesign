...
**Цель**: получить практический опыт использования аспектов и ```АОП```. Написать профайлер для вашего приложения. Профайлер должен быть реализован в аспектно-ориентированной парадигме. Профайлер должен позволять:
...
[Примеры из лекции](https://github.com/akirakozov/software-design/tree/master/java/aop)

**Баллы**:
* самый простой вариант со ```spring-aop``` (10 баллов)
* использование ```aspectj/сбор``` в древовидную структура/другие возможности ```AOP``` (12 баллов)
